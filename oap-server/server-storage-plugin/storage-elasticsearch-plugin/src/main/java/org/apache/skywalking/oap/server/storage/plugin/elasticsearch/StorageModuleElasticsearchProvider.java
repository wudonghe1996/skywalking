...
public class StorageModuleElasticsearchProvider extends ModuleProvider {
    ...
    public void prepare() throws ServiceNotProvidedException {
        ...
        this.registerServiceImplementation(IDayuQueryDao.class, new DayuQueryEsDAO(elasticSearchClient));
        this.registerServiceImplementation(IDayuDAO.class, new DayuEsDAO(elasticSearchClient));
